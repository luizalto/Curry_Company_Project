...
with tab1:
    with st.container():
        ...
        with col1:
            ...
            # A maior e menor idade dos entregadores
        ...
        with col3:
            ...
            # A melhor e pior condisao dos veiculos
            melhor_condicao = df1.loc[:, 'Vehicle_condition'].max()
            col3.metric( 'Melhor condicao', melhor_condicao )

        with col4:
            
            pior_condiçao = df1.loc[:, 'Vehicle_condition'].min()
            col4.metric( 'Pior condicao', pior_condiçao )
    with st.container():
        st.markdown( """---""" )
        st.title( 'Avaliacoes' )
    ...
    with st.container():
        ...
        with col1:
            ...
            st.markdown( 'Top Entregas Mais Rapidas' )
            st.dataframe( df1 )
            top_e_m_r( df1 )
        ...
        with col2:
            ...
            st.markdown( 'Top Entregas Mais Devagar' )
            st.dataframe( df1 )
            top_e_m_d( df1 )
